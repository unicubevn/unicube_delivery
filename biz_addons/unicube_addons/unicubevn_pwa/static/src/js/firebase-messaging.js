                    ...
                    r = async function registerInstallation(e, t) {
                        try {
                            const n = await async function createInstallationRequest({
                                ...
                                const i = {fid: n, authVersion: "FIS_v2", appId: e.appId, sdkVersion: "w:0.6.5"},
...
!function registerMessagingInWindow() {
    t(new Component("messaging", WindowMessagingFactory, "PUBLIC")), t(new Component("messaging-internal", WindowMessagingInternalFactory, "PRIVATE")), e(M, "0.12.6"), e(M, "0.12.6", "esm2017")
}();
